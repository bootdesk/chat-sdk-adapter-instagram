...
class InstagramFormatConverter extends BaseFormatConverter
{
    private MarkdownParser $instagramParser;
    ...
    public function __construct()
    {
        ...
        $this->instagramParser = new MarkdownParser($environment);
    }

    protected function parseMarkdown(string $markdown): Document
    {
        return $this->instagramParser->parse($markdown);
    }
